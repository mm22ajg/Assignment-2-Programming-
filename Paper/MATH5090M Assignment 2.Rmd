...
In the above implementation of the BOP2 clinical trial design we have used $\theta\sim Beta(0.5, 0.5)$ as a prior distribution for $\theta$. Below is the probability density function for this prior distribution

```{r}
x = seq(0,1,0.01)
plot(x, pbeta(x, 0.5, 0.5), type='l')
```
